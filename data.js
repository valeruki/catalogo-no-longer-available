...
catalog = [   
    ...
    "category": 1, 
    "price" : "$30.000", 
    "image": ["033-01.jpg", "033-02.jpg", "033-03.jpg", "033-04.jpg", "033-05.jpg", "033-06.jpg"],
    ...
    */
    ...
    "addi": false,
    "title": "SET DE PULSERAS CON ORO 18KT", 
    "keywords": "SET DE PULSERAS CON ORO 18KT peyote balin oro caballero hombre 066",
    "category": 7, 
    "price" : "$65.000", 
    "image": ["066-01.jpg", "066-02.jpg"],
    "description": "Sistema de cierre con nudo corredizo para graduar a tu muñeca. <br><br><b>Materiales:</b><br>Mostacilla japonesa.<br>Hilo encerado. <br>Un (1) balin de oro 18 quilates tamaño N3mm."}, 
    ...
    "category": 9, 
    "price" : "$28.000", 
    "image": ["116-01.jpg", "116-02.jpg", "116-03.jpg"],
    ...
    {"id": "135", 
    "addi": false,
    "title": "PULSERA DE CUERO NATURAL", 
    "keywords": "PULSERA cilindro cuero NATURAL 135",
    "category": 7, 
    "price" : "$22.000", 
    "image": ["135-01.jpg"],
    ...
    "addi": false,
    "title": "SET DE PULSERAS", 
    "keywords": "SET DE PULSERAS 168",
    "category": 1, 
    "price" : "$31.000", 
    "image": ["168-01.jpg", "168-02.jpg", "168-03.jpg", "168-04.jpg", "168-04.jpg"],
    "description": "Sistema de cierre con nudo corredizo para graduar a tu muñeca. <br><br><b>Materiales:</b>Mostacilla japonesa.<br>Hilo encerado."},   

    {"id": "169", 
    "addi": false,
    "title": "PULSERA", 
    "keywords": "PULSERA nombre infantil niña 169",
    "category": 8, 
    "price" : "$42.000", 
    "image": ["169-01.jpg"],
    "description": "Sistema de cierre con nudo corredizo para graduar a tu muñeca. <br><br><b>Materiales:</b><br>Mostacilla japonesa.<br>Hilo coreano."}, 
    ...
    "addi": false,
    "title": "MAXIARETES CAYENA", 
    "keywords": "MAXIARETES CAYENA aretes rojo hexagono 170",
    "category": 3, 
    "price" : "$80.000", 
    "image": ["170-01.jpg"],
    "description": "Inspirados en la flor de bonche y su color intenso rojo que adorna los patios y terrazas de las casas de nuestra región sabanera.<br><br><b>Materiales:</b><br>Mostacilla japonesa.<br>Topos de acero dorado."},  
    ...
    {"id": "171", 
    "addi": false,
    "title": "TOBILLERA MARIPOSA", 
    "keywords": "TOBILLERA MARIPOSA 171",
    "category": 4, 
    "price" : "$35.000", 
    "image": ["171-01.jpg"],
    "description": "Sistema de cierre con nudo corredizo para graduar a tu tobillo. <br><br><b>Materiales:</b><br>Mostacilla japonesa.<br>Hilo coreano. <br>Hilos con brillo."},   

    {"id": "172", 
    "addi": true,
    "title": "MAXIARETES CINTA DE AMOR", 
    "keywords": "MAXIARETES CINTA DE AMOR 172",
    "category": 3, 
    "price" : "$115.000", 
    "image": ["172-01.jpg", "172-02.jpg", "172-03.jpg"],
    "description": "Inspirados en la planta llamada Cinta de amor, que adorna las terrazas de las casas Sucreñas.<br><br><b>Materiales:</b><br>Mostacilla japonesa.<br>Topos de acero dorado."},   
    ...
    "addi": true,
    "title": "SET DE PULSERAS CON ORO 18 KT", 
    "keywords": "SET DE PULSERAS CON ORO 18 QUILATES 175",
    "category": 1, 
    "price" : "$148.000", 
    ...
    {"id": "176", 
    "addi": false,
    "title": "SET DE PULSERA MASCOTA", 
    "keywords": "SET DE PULSERA MASCOTA 176",
    "category": 1, 
    "price" : "$56.000", 
    "image": ["176-01.jpg"],
    "description": "Sistema de cierre con nudo corredizo para graduar a tu muñeca. <br><br><b>Materiales:</b><br>Mostacilla japonesa.<br>Hilo encerado."},   
    ...
    {"id": "177", 
    "addi": false,
    "title": "CADENA CON DIJE CORAZÓN", 
    "keywords": "CADENA CON DIJE CORAZÓN 177",
    "category": 2, 
    "price" : "$37.000", 
    "image": ["177-01.jpg"],
    "description": "<b>Materiales:</b><br>Mostacilla japonesa.<br>Cadena de acero dorado, medida aproximada de 40cm. (Los tejidos varian según disponibilidad)."}, 
    ...
    "keywords": "PULSERA OLAS MARINAS 178 azul",
    "category": 1, 
    "price" : "$37.000", 
    "image": ["178-01.jpg"],
    "description": "Sistema de cierre con nudo corredizo para graduar a tu muñeca. <br><br><b>Materiales:</b><br>Mostacilla japonesa.<br>Hilo encerado."},  
    */
    ...
    {"id": "180", 
    "addi": false,
    "title": "TOBILLERA SAGRADO CORAZÓN", 
    "keywords": "TOBILLERA SAGRADO CORAZoN 180",
    "category": 4, 
    "price" : "$25.000", 
    "image": ["180-01.jpg"],
    "description": "Sistema de cierre con nudo corredizo para graduar a tu tobillo.<br><br><b>Materiales:</b><br>Mostacilla japonesa.<br>Hilo encerado."},    
    ...
    {"id": "190", 
    "addi": false,
    "title": "TOBILLERA CORAZÓN", 
    "keywords": "TOBILLERA CORAZÓN 190",
    "category": 4, 
    "price" : "$30.000", 
    "image": ["190-01.jpg"],
    "description": "Sistema de cierre con nudo corredizo para graduar a tu tobillo.<br><br><b>Materiales:</b><br>Mostacilla japonesa.<br>Hilo coreano."},  
    ...
    {"id": "192", 
    "addi": true,
    "title": "SET DE PULSERAS MASCOTA CON ORO 18 KT", 
    "keywords": "SET DE PULSERAS MASCOTA CON ORO 18 KT 192 perro perrito",
    "category": 1, 
    "price" : "$142.000", 
    "image": ["192-01.jpg"],
    "description": "Sistema de cierre con nudo corredizo para graduar a tu muñeca. <br><br><b>Materiales:</b><br>Mostacilla japonesa.<br>Hilo encerado.<br>Hilos con brillo.<br>Cuatro 4 balines de oro 18 quilates tamaño n3mm."},  

    {"id": "193", 
    "addi": false,
    "title": "SET DE PULSERAS", 
    "keywords": "SET DE PULSERAS 193",
    "category": 7, 
    "price" : "$62.000", 
    "image": ["193-01.jpg"],
    ...
    {"id": "194", 
    "addi": false,
    "title": "JOYAS PARA COMPARTIR COLOMBIA", 
    "keywords": "JOYAS PARA COMPARTIR COLOMBIA 194 bandera",
    "category": 10, 
    "price" : "$38.000", 
    "image": ["194-01.jpg"],
    "description": "Sistema de cierre con nudo corredizo para graduar a tu muñeca. <br><br><b>Materiales:</b><br>Mostacilla japonesa.<br>Hilo encerado."},
    ...
    {"id": "195", 
    "addi": false,
    "title": "COLLAR CHOKER CON CRISTALES", 
    "keywords": "COLLAR CHOKER CON CRISTALES 195",
    "category": 2, 
    "price" : "$25.000", 
    "image": ["195-01.jpg"],
    "description": "<b>Materiales:</b><br>Mostacilla japonesa.<br>Cristales de Suaroski. <br>Sistema de cierre con herrajes de acero dorado.<br>Medida aproximada de choker entre 35 a 37 cm. <br>"},

    {"id": "196", 
    "addi": false,
    "title": "COLLAR CHOKER CON INICIAL", 
    "keywords": "COLLAR CHOKER CON INICIAL letra l 196",
    "category": 2, 
    "price" : "$35.000", 
    "image": ["196-01.jpg"],
    "description": "<b>Materiales:</b><br>Mostacilla japonesa.<br>Sistema de cierre con herrajes de acero dorado.<br>Medida aproximada de choker entre 36 a 38 cm."},

    {"id": "197", 
    "addi": false,
    "title": "SET DE PULSERAS CON INICIAL", 
    "keywords": "SET DE PULSERAS CON INICIAL letra e 197",
    "category": 1, 
    "price" : "$38.000", 
    "image": ["197-01.jpg"],
    "description": "Sistema de cierre con nudo corredizo para graduar a tu muñeca. <br><br><b>Materiales:</b><br>Mostacilla japonesa."},

    {"id": "198", 
    "addi": false,
    "title": "CAJA DE REGALO", 
    "keywords": "CAJA DE REGALO 198",
    "category": 9, 
    "price" : "$34.000", 
    "image": ["198-01.jpg"],
    "description": "Caja de regalo con joyas tejidas a mano por artesanos de la ciudad de Sincelejo - Sucre.<br><br>Complementamos con otros productos de marcas Sucreñas o Nacionales.<br><br>1. Pulsera caballero: $25.000.<br>2. Cerveza Corona lata: $6.000.<br>3. Frutos secos Natri: $3.000.<br><br>Se obsequia la caja decorativa que incluye: lazo en tela, tarjeta escrita en máquina, aplique floral seco."},

    {"id": "199", 
    "addi": false,
    "title": "JOYAS PARA COMPARTIR", 
    "keywords": "JOYAS PARA COMPARTIR pareja 199",
    "category": 10, 
    "price" : "$30.000", 
    "image": ["199-01.jpg", "199-02.jpg"],
    "description": "Sistema de cierre con nudo corredizo para graduar a tu muñeca. <br><br><b>Materiales:</b><br>Mostacilla japonesa.<br>Hilo encerado."},

    {"id": "200", 
    "addi": false,
    "title": "SET DE CADENA Y ARETES CON INICIAL", 
    ...
    "addi": false,
    "title": "TOBILLERA CORAZÓN", 
    "keywords": "TOBILLERA CORAZON 201",
    "category": 4, 
    "price" : "$23.000", 
    "image": ["201-01.jpg"],
    "description": "<b>Materiales:</b><br>Mostacilla japonesa.<br>Hilo encerado."},
    ...
    "addi": false,
    "title": "JOYAS PARA COMPARTIR", 
    "keywords": "JOYAS PARA COMPARTIR 203",
    "category": 10, 
    "price" : "$33.000", 
    "image": ["203-01.jpg"],
    "description": "Sistema de cierre con nudo corredizo para graduar a tu muñeca. <br><br><b>Materiales:</b><br>Mostacilla japonesa.<br>Hilo encerado."},
    ...
    "addi": true,
    "title": "SET DE PULSERA CON ORO 18KT", 
    "keywords": "SET DE PULSERA CON ORO 18KT 208",
    "category": 1, 
    "price" : "$185.000", 
    "image": ["208-01.jpg"],
    "description": "Sistema de cierre con nudo corredizo para graduar a tu muñeca. <br><br><b>Materiales:</b><br>Mostacilla japonesa.<br>Hilo encerado.<br>Cuatro (4) balin de oro 18 quilates tamaño N4mm."},

    {"id": "209", 
    "addi": false,
    "title": "JOYAS PARA COMPARTIR", 
    "keywords": "JOYAS PARA COMPARTIR 209",
    "category": 10, 
    "price" : "$60.000", 
    "image": ["209-01.jpg"],
    "description": "Sistema de cierre con nudo corredizo para graduar a tu muñeca.<br><br><b>Materiales:</b><br>Mostacilla japonesa.<br>Hilo encerado."},
